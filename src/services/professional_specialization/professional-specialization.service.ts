...
import type { CreatePayload, CreateResponse, DeletePayload, DeleteResponse, ReadAllResponse, ReadSingleQuery, ReadSingleResponse, UpdatePayload, UpdateResponse } from './professional-specialization.types'

const API_URL = import.meta.env.VITE_BASE_API_URL + 'professional_specialization/'
...
class ProfessionalSpecializationService {
...
export default new ProfessionalSpecializationService()